    ...
    <footer className="py-10 px-4 border-t dark:border-white/10 light:border-black/8">
      <div className="mx-auto max-w-6xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-sm text-muted-foreground">
          Built with <span className="text-red-400">❤</span> by Yogesh M T · 2026
        </p>
        <div className="flex gap-3">
          {[
              { Icon: GitBranch, href: "https://github.com/Yogesh0244" },
              { Icon: ExternalLink, href: "https://linkedin.com/in/yogeshmt" },
            { Icon: Mail, href: "mailto:yogeshmt02@gmail.com" },
          ].map(({ Icon, href }, i) => (
            <a
              key={i}
              href={href}
